...
</div><h3 id="Features_with_role" class="api"><span class="prefix">Features.</span><span class="name">with_role</span><span class="paren">(</span>roles<span class="paren">)</span></h3><div class="api" markdown="1">
